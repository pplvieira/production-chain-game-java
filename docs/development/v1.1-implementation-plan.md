...
- **Format**: `v1.1.X`
  ...
  - Third digit: **Increments with each commit**
- **Phase Notation**: `v1.1.X-phaseN`
  - Phase 1 (Cleanup): v1.1.1-phase1
  - Phase 2 (Core Dev): v1.1.2-phase2
  - Phase 3 (Testing): v1.1.3-phase3
  - Phase 4 (Documentation): v1.1.4-phase4
- **Commit Format**: `<type>: v1.1.X - <description>`
  - Example: `feat: v1.1.5 - Add ResourceLoader utility class`
  - Example: `fix: v1.1.6 - Correct path resolution in BuildingInstance`
...
## Phase 1: Cleanup & Refactoring (v1.1.1-phase1)
...
## Phase 2: Core Development (v1.1.2-phase2)
...
## Phase 3: Testing & Quality Assurance (v1.1.3-phase3)
...
## Phase 4: Documentation & Polish (v1.1.4-phase4)
...
|-------|-------|------------|----------|-----------------|--------|
| **Phase 1: Cleanup** | v1.1.1-phase1 | TBD | TBD | 18-22 hours | Planning |
...
| **Phase 2: Core Dev** | v1.1.2-phase2 | TBD | TBD | 33-42 hours | Planning |
...
| **Phase 3: Testing** | v1.1.3-phase3 | TBD | TBD | 45-58 hours | Planning |
...
| **Phase 4: Docs** | v1.1.4-phase4 | TBD | TBD | 19-26 hours | Planning |
